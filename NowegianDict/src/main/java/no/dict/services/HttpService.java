...
public class HttpService {
	 ...
	 * @return
	 */
	public static String getDocumentFromWeb(String url) {
		try {
	...
	public static String getURL(String word, int from) {
		return "http://lexin.udir.no/?search=" + word + "&dict=nbo-maxi&ui-lang=NBO&startingfrom=" + from
				+ "&count=5&checked-languages=E&checked-languages=N";
	}
