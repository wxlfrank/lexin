...
public class BuildDictionary extends AbstractThread {
    ...
    BlockingQueue<Document> downloaded = new ArrayBlockingQueue<Document>(QUEUE_SIZE);
    /**
    ...
    public void createChildren(){
    	extractor = new Extractor(hash, dict, downloaded);
        downloader = new Downloader(hash, downloaded, extractor);
        downloader.start();
        extractor.start();
    }
